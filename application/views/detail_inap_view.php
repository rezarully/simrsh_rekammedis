...
<html lang="en">
  <head>
    ...
    <title>SIM RSH Prof. Soeparwi | Detail Rawat Inap</title>
  ...
  <div class="container">
    ...
    <div class="panel-heading"><b>Detail Rekam Medis - Rawat Inap</b></div>
    <div class="panel-body">
       ...
       <p><a href="daftar_rm" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-repeat"></i> Kembali</a>  <a href="javascript:window.print()" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-print"></i> Cetak</a></p>         
        ...
        <?php 
          ...
          $query = $this->db->query("SELECT * FROM `inputrminap` WHERE  id = $id_detail_jalan");
          $data = $query->row();
          ...
          $semester_mahasiswa = $data->semester_mahasiswa;
          ...
          $ket_pengobatan = $data->ket_pengobatan;
        ?>
          ...
          <div class="col-xs-12">
            ...
            <div class="col-xs-6">
              ...
              <div class="form-group">
                <label class="col-xs-6">Diagnosis</label>
                <label class="col-xs-6">: <?php echo $diagnosis ?></label>
              </div>
            </div>
            <div class="col-xs-6">
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-xs-6">Berat Badan</label>
                <label class="col-xs-6">: <?php echo $berat_badan ?></label>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-xs-6">Semester</label>
                <label class="col-xs-6">: <?php echo $semester_mahasiswa ?></label>
              </div>
            </div>
          </div>
          ...
          <br>
            <table class="table">
              ...
              <tr>
                <td>Keterangan Pengobatan</td>
                <td><?php echo $ket_pengobatan?></td>
              </tr>
            </table>
          </div>
