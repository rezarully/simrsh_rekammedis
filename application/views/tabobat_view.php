                          ...
                          <table class="table table-striped">
                            ...
                            <tbody class="tbodyClone3a">
                              <tr id="clonedInput3a" class="clonedInput3a">
                                ...
                                <td><button name="buttonresep" type="button" class="buttonresep btn btn-primary"><i class="fa fa-plus-circle">+</i></button></td>
                                <td><button name="buttonbatalresep" type="button" class="buttonbatalresep btn btn-primary"><i class="fa fa-circles"></i>x</button></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
