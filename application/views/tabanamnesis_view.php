                  ...
                  <div class="col-md-12">
                    <div class="form-horizontal">
                      <div class="form-group">
                        <label for="anamnesis" class="col-md-2">Anamnesis</label>
                        <div class="col-md-5">
                          <textarea class="form-control" name="anamnesis" rows="4"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="pernafasan" class="col-md-2">Pernafasan</label>
                        <div class="col-md-5">
                      ...
                      <div class="form-group">
                        <label for="pencernaan" class="col-md-2">Pencernaan</label>
                        <div class="col-md-5">
                          <input type="text" class="form-control" name="pencernaan">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="syaraf" class="col-md-2">Syaraf</label>
                        <div class="col-md-5">
                          <input type="text" class="form-control" name="syaraf">
                        </div>
                      </div>
                      <div class="form-group">
